...
namespace Cars.Repository.Test
{
    public class VehicleModelRepositoryTests
    {
        ...
        {
            var mockModelRepository = new Mock<IVehicleModelRepository>();
            ...
            mockModelRepository.Setup(mr => mr.FindAllModelsPaged(It.IsAny<SortingParameters>(), It.IsAny<FilteringParameters>(), It.IsAny<PagingParameters>()))
                .ReturnsAsync(new PaginationList<VehicleModelEntity>(updateList, updateList.Count(), It.IsAny<int>(), It.IsAny<int>()));
            ...
            mockModelRepository.Setup(mr => mr.Create(It.IsAny<VehicleModelEntity>())).Returns(
                (VehicleModelEntity target) =>
                {
            ...
            mockModelRepository.Setup(mr => mr.Update(It.IsAny<VehicleModelEntity>()));

            mockModelRepository.Setup(mr => mr.Delete(It.IsAny<int>())).Callback<VehicleModelEntity>((entity) => updateList.Remove(entity));
        ...
        public void GetAll()
        {
            ...
            PaginationList<VehicleModelEntity> testMakes = _mockModelRepository.FindAllModelsPaged(sortingParams, filteringParams, pagingParams).Result;
        ...
        public void GetById()
        {
            var testModel = _mockModelRepository.FindById(2).Result;
        ...
        public void Add()
        {
            ...
            int modelCount = _mockModelRepository.FindWithMakeById(3).Count();

            modelCount.Should().Be(1);

            VehicleModelEntity testModel = _mockModelRepository.FindById(5).Result;
        ...
        public void Update()
        {
            VehicleModelEntity testModel = _mockModelRepository.FindById(3).Result;

            testModel.Abrv = "7";

            _mockModelRepository.Update(testModel);

            VehicleModelEntity getModel = _mockModelRepository.FindById(3).Result;
